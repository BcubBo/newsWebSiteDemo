...
>
	<table  width="100%" border="0" cellspacing="5" cellpadding="0">
		...
		<tbody>
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2" >分类</td>
			...
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2" id="checkPoint">标题</td>
				<td style="text-align:left;"><input type="text" name="title" value=""/></td>
			</tr>
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2">作者</td>
				<td style="text-align:left;"><input type="text" name="author" value=""/></td>
			</tr>
			
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2">摘要</td>
				<td style="text-align:left;"><textarea id="summary" name="summary" rows="8" cols="50"></textarea></td>
			</tr>
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2">内容</td>
				<td style="text-align:left;">
				<div id="xToolbar"></div>
				<textarea id="newscontent" name="newscontent" rows="8" cols="30"></textarea></td>
			</tr>
			<tr>
				<td name="checkBox" style="text-align:right;" class="text_tabledetail2">上传图片 </td>
				<td style="text-align:left;"><input type="file" name="picPath" value=""/></td>
			</tr>
			<tr>
				<td name="checkBox" style="text-align:center;" colspan="2">
